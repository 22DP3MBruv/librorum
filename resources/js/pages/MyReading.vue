...
const updatePage = async (progress) => {
  ...
  // Validification for non-integer and empty values
  ...
  // Validification for negative page values
  if (page < 0) {
  ...
  // Validification for page values exceeding total page count
